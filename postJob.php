...
if(isset($_POST["postJob"])){
    ...
    $sql = "INSERT INTO job_offer (title, type, description, budget, skills, special_skill, e_username, valid, deadline, f_name, m_name, l_name, picture) VALUES ('$title', '$type', '$description','$budget','$skills','$special_skill','$username',1, '$deadline', '$f_name', '$m_name', '$l_name', '$picture' )";
                                                                                                                        // Hey!! ^^^ ^^^^^^ ^^^^^^   ^^^^^             
