...
if(isset($_POST["approve"])){
   ...
   $username=test_input($_POST["username"]);
	...
	$sql = "INSERT INTO employee (username, password, profilepic, fname, mname, lname, Email, Gender, Age, Bdate, mnumber, address, city, province, zipcode) VALUES ('$username', '$password', '$profilepic','$fname',, '$mname', '$lname', '$Email', '$Gender', '$Age', '$Bdate', '$mnumber', '$address', '$zipcode', '$city', '$province', '$validID')";
    
    $result = $conn->query($sql);
    if($result==true){
      $linkBtn="index.php";
    	$sql = "DELETE FROM employe WHERE id='$username'";
		$result = $conn->query($sql);
		}
    }
                           ...
                           ?>
                            <tr>
                                ...
                                <td style="font-size: 20px"><?php
                                 ...
                                 ?></td>
                                <td style="font-size: 30px"><?php echo $row['zipcode']; ?></td>
                                <td style="font-size: 30px"><?php echo $row['username']; ?></td>
                                <td style="font-size: 30px"><button data-id='<?php echo $row['id']; ?>' class="userinfo btn btn-success">Info</button></td>
                            </tr>
                        <?php } ?>
                                </tbody>
                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                           <button type="submit" name="postJob" class="btn btn-info">Approve</button>
